...
# data generation
x, y = data_creator.generate_data(seed=222)
x_train, y_train, x_test, y_test = data_creator.train_test_split(x, y)
...
clf = LogisticRegression(learning_rate=0.1, max_iter=500, seed=222)
